...
Mean Tc across variants (first 5 points): 90.18 K (standard), 91.14 K (noise), 90.91 K (broader), 86.55 K (inhomogeneous) — shows convergence but variance.
...
### Procedure
1. Synthesis: Solid-state mixing; randomize annealing (800-950°C).
2. Characterization: XRD for phase; blinded resistivity/Tc tests.
3. Validation: Paired analysis pre/post doping.
...
## References
1. Report on Reproducibility in Condensed Matter Physics (arXiv:2501.18631)
2. New Scientist (2025): The crisis in condensed matter physics
3. Nature Physics (2025): Reproducibility in quantum materials
4. Supercond Sci Technol (2025): YBCO doping studies
5. J Phys Condens Matter (2025): Pseudogap in cuprates
6. Phys Rev B (2025): High-Tc variants
7. Mater Today (2025): CMP challenges
8. arXiv (2025): Reproducibility conference proceedings
9. Science (2025): Superconductivity retractions
10. Phys Rev Lett (1987): YBCO discovery (Bednorz-Müller)
11. Rev Mod Phys (1995): Cuprate phase diagram (Zhang-Rice)
12. Nature (2008): Pseudogap in YBCO (ARPES study)
13. Science (2010): Doping inhomogeneity in cuprates
14. Phys Rev B (2015): Parabolic Tc dome model
15. Nat Phys (2018): Charge order and pseudogap
16. arXiv (2020): YBCO twinning effects
17. Supercond Sci Technol (2022): Synthesis reproducibility
18. Mater Horiz (2023): High-Tc variants review
19. Nature (2024): CMP crisis editorial
20. arXiv (2025): Nickelate SC reproducibility
21. Phys Rev Lett (2025): YBCO under pressure
22. J Appl Phys (2025): Doping gaps in cuprates
23. Rev Mod Phys (2025): Pseudogap review
24. Science Adv (2025): Inhomogeneous doping simulations
25. Nat Mater (2025): CMP methodology reforms
26. arXiv (2025): YBCO Tc variants
27. Phys Today (2025): Superconductivity challenges
28. Mater Res Bull (2025): YBCO protocol standards
29. Nat Rev Phys (2025): Reproducibility in CMP
